...
import com.cl.house.api.common.HouseUserType;
import com.cl.house.api.common.RestResponse;
import com.cl.house.api.config.GenericRest;
import com.cl.house.api.model.City;
import com.cl.house.api.model.Community;
import com.cl.house.api.model.House;
import com.cl.house.api.model.HouseQueryReq;
import com.cl.house.api.model.HouseUserReq;
import com.cl.house.api.model.ListResponse;
import com.cl.house.api.model.UserMsg;
import com.cl.house.api.utils.Rests;
...
public class HouseDao {
  ...
  public List<Community> getAllCommunitys() {
    RestResponse<List<Community>> resp = Rests.exc(() -> {
        ...
        RestResponse<List<Community>> body = responseEntity.getBody();
        return responseEntity.getBody();
     });
     return resp.getResult();
  }
